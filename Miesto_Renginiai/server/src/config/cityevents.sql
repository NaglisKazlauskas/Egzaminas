...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `is_admin`, `created_at`, `banned`) VALUES
(1, 'admin', 'admin@example.com', '$2b$10$bXwYCz/7pk4PXQPjGrcWleBYP8d8ESW1zsSl317/IclCtSZoM2mfu', 1, '2025-06-20 07:35:52', 0),
(6, 'test', 'test@user.com', '$2b$10$HlfF504dvJOoMzoLDJwkE.utjxxrZBDLB1teNqhrFQH3NnkhpJ4oK', 0, '2025-06-20 11:28:27', 0);
